...
namespace WebUI.Tests.UnitTests.Repositories
{
	public class TodoListRepositorySpec
	{
		...
		private IEnumerable<TodoList> SetupLists(params TodoList[] lists)
		{
		...
		{
			var list = SetupLists(new TodoList { Id = "SOME ID" }).First();
